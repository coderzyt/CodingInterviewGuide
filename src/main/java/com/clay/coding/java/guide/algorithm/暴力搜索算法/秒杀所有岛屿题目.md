...
这里额外说一个处理二维数组的常用小技巧，你有时会看到使用「方向数组」来处理上下左右的遍历，和前文 [图遍历框架](https://labuladong.gitee.io/algo/2/22/50/) 的代码很类似：
...
[![](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/1.jpg)](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/1.jpg)
...
> PS：这类 DFS 算法还有个别名叫做 [FloodFill 算法](https://labuladong.github.io/article/fname.html?fname=FloodFill%e7%ae%97%e6%b3%95%e8%af%a6%e8%a7%a3%e5%8f%8a%e5%ba%94%e7%94%a8)，现在有没有觉得 FloodFill 这个名字还挺贴切的~
...
[![](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/2.png)](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/2.png)
...
> PS：处理这类岛屿题目除了 DFS/BFS 算法之外，Union Find 并查集算法也是一种可选的方法，前文 [Union Find 算法运用](https://labuladong.gitee.io/algo/2/22/53/) 就用 Union Find 算法解决了一道类似的问题。
...
[![](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/3.jpg)](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/3.jpg)
...
[![](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/4.jpg)](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/4.jpg)

**这道题的关键在于，如何快速判断子岛屿** ？肯定可以借助 [Union Find 并查集算法](https://labuladong.gitee.io/algo/2/22/53/) 来判断，不过本文重点在 DFS 算法，就不展开并查集算法了。
...
[![](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/5.jpg)](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/5.jpg)

其中有四个岛屿，但是左下角和右上角的岛屿形状相同，所以不同的岛屿共有三个，算法返回 3。

很显然我们得想办法把二维矩阵中的「岛屿」进行转化，变成比如字符串这样的类型，然后利用 HashSet 这样的数据结构去重，最终得到不同的岛屿的个数。

如果想把岛屿转化成字符串，说白了就是序列化，序列化说白了就是遍历嘛，前文 [二叉树的序列化和反序列化](https://labuladong.gitee.io/algo/2/21/39/) 讲了二叉树和字符串互转，这里也是类似的。
...
[![](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/6.png)](https://labuladong.gitee.io/algo/images/%e5%b2%9b%e5%b1%bf/6.png)
...
这样，这道题就解决了，至于为什么初始调用 `dfs` 函数时的 `dir` 参数可以随意写，这里涉及 DFS 和回溯算法的一个细微差别，前文 [图算法基础](https://labuladong.gitee.io/algo/2/22/50/) 有写，这里就不展开了。
