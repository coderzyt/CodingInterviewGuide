前文 [前缀和技巧详解](https://labuladong.gitee.io/algo/2/20/24/) 写过的前缀和技巧是非常常用的算法技巧， **前缀和主要适用的场景是原始数组不会被修改的情况下，频繁查询某个区间的累加和** 。
...
[![](https://labuladong.gitee.io/algo/images/%e5%b7%ae%e5%88%86%e6%95%b0%e7%bb%84/2.jpeg)](https://labuladong.gitee.io/algo/images/%e5%b7%ae%e5%88%86%e6%95%b0%e7%bb%84/2.jpeg)
...
classDifference{
    ...
    publicvoidincrement(int i,int j,int val){
        diff[i] += val;
        if (j + 1 < diff.length) {
            diff[j + 1] -= val;
        }
...
[![](https://labuladong.gitee.io/algo/images/%e5%b7%ae%e5%88%86%e6%95%b0%e7%bb%84/title1.png)](https://labuladong.gitee.io/algo/images/%e5%b7%ae%e5%88%86%e6%95%b0%e7%bb%84/title1.png)
...
![img](https://labuladong.gitee.io/algo/images/%e5%b7%ae%e5%88%86%e6%95%b0%e7%bb%84/title.png)
...
```java
booleancarPooling(int[][] trips,int capacity);
```
